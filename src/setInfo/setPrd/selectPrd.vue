	...
	<view class="mobile-setInfo-wrapper backBg">
		<rrf-page-container :scrollbar="false">
			...
			<view class="setInfo-content"  v-if="swiperTab.length > 0" >
				...
				<view class="footer">
					<GoodsAction  :isFType="1" :swiperTab="swiperTab.filter((i,index) => index == current)" :info="priceInfo" :type="swiperTab[current].type" v-if="priceInfo"></GoodsAction>
				</view>
			</view>
...
<style lang="scss" scoped>
	...
	.mobile-setInfo-wrapper{
		...
		.setInfo-content{
			min-height: calc(100% - 148rpx - 52rpx);
